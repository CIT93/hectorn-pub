...
const getLS = () => {
  ...
  if (retrievedArr !== null) {
    ...
    return JSON.parse(retrievedArr); // if what you bring is not null (something IS in there when bringing it back) parse the relieved array and return it to be used into code
  } else {
